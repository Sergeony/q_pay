...
import {GetTransactionsRequestProps, useGetDepositTransactionsQuery} from "../../../src/_service/transactionsService";
            ...
            <StyledRow>
              <Bank>
                ...
                <Values>
                  ...
                  <Value>
                    <TetherIcon/>
                    <SecondLine>{(Number(t.amount) / Number(t.actual_amount)).toPrecision(4)}₮</SecondLine>
                  </Value>
                </Values>
              </Bank>
