...
from rest_framework_simplejwt.authentication import JWTAuthentication as DefaultJWTAuthentication, AuthUser
...
def user_authentication_rule(user: AuthUser) -> bool:
    return user is not None and not user.is_deleted
