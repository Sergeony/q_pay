...
# def create_user_wallet(user: User):
#     tron = Tron(full_node=settings.QPAY_TRON_NODE["full_node"],
#                 solidity_node=settings.QPAY_TRON_NODE["solidity_node"],
#                 event_server=settings.QPAY_TRON_NODE["event_server"])
#
...
#             private_key_encrypted=encrypt(account.private_key)
#         )
