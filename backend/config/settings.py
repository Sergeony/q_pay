...
REFRESH_SECURE_SSL_REDIRECT = True
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        # "apps.api.authentication.SignatureAuthentication",  # TODO: consider it: by uncommenting it will causing 403 instead of proper 401
...
TT_LIFETIME = timezone.timedelta(minutes=5)

EVC_RESEND_LIMIT = 10
EVC_RESEND_LIMIT_PERIOD = timezone.timedelta(hours=1)
EVC_LIFETIME = timezone.timedelta(minutes=5)
EVC_LENGTH = 6
